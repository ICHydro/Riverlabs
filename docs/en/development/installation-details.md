...
The Wari logger uses a Maxbotix ultrasonic distance sensors, with a maximum theoretical range of 5&nbsp;m. However, in practice the range may be slightly lower, especially for surfaces with low reflectivity. Most water surfaces reflect well but it is recommended to build in a margin of around 0.5&nbsp;m.
