...
3. We recommend organizing by deployment or location, for example:
   ```
   My Documents/
   └── Logger Data/
       └── Site A - Jan 2026/
...
1. Open your spreadsheet application (e.g., Excel or Google Sheets)
2. Open the CSV file
...
| **View data**      | Open .CSV file in Excel/Google Sheets        |
| **Data columns**   | DateTime, 10x Distance, Voltage, Temperature |
| **Re-insert card** | Insert card → Press RESET                    |
