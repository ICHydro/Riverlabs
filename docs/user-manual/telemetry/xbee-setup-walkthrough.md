...
!!! abstract "Overview"
    ...
    **Compatibility:** XBee 3G, XBee Cellular LTE-M/NB-IoT, XBee3 Cellular
...
!!! info "Configuration Tools"
    ...
    - **Serial interface settings** (baud rate, parity, timeouts)
...
| **Packetization Timeout** | RO | **3** | Character timeout (3ms) |
...
| Setting | Parameter | Value | Description |
|---------|-----------|-------|-------------|
| **Guard Time** | GT | **3E8** (1000ms) | Command mode delay |
...
If settings reset: Configuration wasn't written properly. Repeat Part 6.
